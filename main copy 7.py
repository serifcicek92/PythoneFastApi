...
def ask_question(data: Question):
    ...
    try:
        ...
        system_content = f"""
Sen Boyut Bilgisayar adına nervus programı için görev yapan bir yapay zekasın.

Vereceğin cevaplar her zaman {{"response":"Yanıtın mesaj kısmı.","system_debug":"sisteme vermek istediğin mesaj varsa","bilgiiste":**true/false**,"endpoint":"..."}} şeklinde yanlızca json formatında olmalı. Chat için bir mesajın varsa **response** keyinin value kısmına yaz.
...
-[ENDPOINTLER] olarak belirttiğim listede bir endpoint varsa endpointi hiçbirşekilde değiştirmeden jsondaki endpoint keyine value olarak yaz.Kesinlike endpointi Büyük/küçük harf veya kelime değiştirme olduğu gibi kalsın. Mesajın varsa response keyine olduğu gibi yaz. 
